...
export default function HeroSection() {
  return (
    ...
    >
      {/* Content Wrapper */}
      <div className="max-w-7xl mx-auto px-6 pt-[80px] pb-24 flex flex-col justify-center h-full z-10">
      ...
      <button className="absolute right-6 bottom-12 w-14 h-14 rounded-full border border-white/50 hover:bg-white/10 flex items-center justify-center transition">
